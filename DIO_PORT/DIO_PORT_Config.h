/*
 * DIO_AUTOSAR_Config.h
 *
 *  Created on: 15 Dec 2023
 *      Author: MR.X
 */

#ifndef DIO_PORT_CONFIG_H_
#define DIO_PORT_CONFIG_H_
...
/* if input 0 push pull output if output 0 LOW*/
/* if input 1 pull up output if output 1 HIGH*/
